...
int main(int argc, char* argv[]) {
  ...
  bool r = command_line::handle_error_helper(desc_all, [&]() {
    ...
    else
    {
      ...
      std::cout << "Windows:   simplewallet.exe --config-file configs/electroneum.conf" << std::endl;
      std::cout << "Linux/Mac:   ./simplewallet --config-file configs/electroneum.conf" << std::endl;
      return false;
    }
    po::notify(vm);
    return true;
